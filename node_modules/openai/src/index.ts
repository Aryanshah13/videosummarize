...
export interface ClientOptions {
  /**
   * Defaults to process.env['REDACTED'].
   */
  ...
  constructor({
    ...
    if (apiKey === undefined) {
      throw new Errors.OpenAIError(
        "The REDACTED environment variable is missing or empty; either provide it, or instantiate the OpenAI client with an apiKey option, like new OpenAI({ apiKey: 'My API Key' }).",
      );
    }
...
export interface AzureClientOptions extends ClientOptions {
  ...
  /**
   * Defaults to process.env['AZURE_REDACTED'].
   */
  apiKey?: string | undefined;
...
export class AzureOpenAI extends OpenAI {
  ...
  constructor({
    baseURL = Core.readEnv('OPENAI_BASE_URL'),
    apiKey = Core.readEnv('AZURE_REDACTED'),
    ...
    if (!azureADTokenProvider && !apiKey) {
      throw new Errors.OpenAIError(
        'Missing credentials. Please pass one of `apiKey` and `azureADTokenProvider`, or set the `AZURE_REDACTED` environment variable.',
      );
    }
